      ...
      <AnimatePresence>
        {isModalOpen && (
          <motion.div 
            ...
            className="fixed inset-0 z-[120] flex items-center justify-center p-4 bg-[#f5f5f4]/80 backdrop-blur-md"
          >
            <motion.div 
              ...
              className="bg-white border border-black/10 rounded-3xl p-8 max-w-md w-full relative shadow-xl"
            >
              <button 
                type="button"
                onClick={() => setIsModalOpen(false)}
              ...
              <div className="relative z-10">
                <h2 className="text-2xl font-bold tracking-tight mb-2">Contáctanos</h2>
                <p className="text-sm text-gray-500 mb-8 font-light">Cuéntanos sobre tu organización y cómo podemos ayudar.</p>
                
                <form className="space-y-4" onSubmit={(e) => { e.preventDefault(); setIsModalOpen(false); }}>
                  <div>
                    <input type="text" placeholder="Tu Nombre o Empresa" className="w-full bg-gray-50 border border-gray-200 rounded-xl px-4 py-3 text-sm text-black placeholder-gray-400 focus:outline-none focus:border-black transition-colors" required />
                  </div>
                  <div>
                    <input type="email" placeholder="Correo electrónico" className="w-full bg-gray-50 border border-gray-200 rounded-xl px-4 py-3 text-sm text-black placeholder-gray-400 focus:outline-none focus:border-black transition-colors" required />
                  </div>
                  <div>
                    <textarea placeholder="¿En qué podemos ayudar?" rows={4} className="w-full bg-gray-50 border border-gray-200 rounded-xl px-4 py-3 text-sm text-black placeholder-gray-400 focus:outline-none focus:border-black transition-colors resize-none" required></textarea>
                  </div>
                  <button type="submit" className="w-full mt-4 bg-black hover:bg-gray-800 text-white font-bold text-xs tracking-widest uppercase py-4 rounded-xl transition-colors cursor-pointer">
                    Enviar Mensaje
                  </button>
                </form>
              </div>
